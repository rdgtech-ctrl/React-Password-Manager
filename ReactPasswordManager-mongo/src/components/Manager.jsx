...
const Manager = () => {
    ...
    return (
        <>
            ...
            <div className="p-3 md: md:mycontainer min-h-[88.2vh]">
                    ...
                    <div className="flex flex-col md:flex-row w-full justify-between gap-8">
                        ...
                        <div className="relative">
                            ...
                            <input ref={passwordRef} value={form.password} onChange={handleChange}
                                placeholder="Enter Password" className="rounded-full border border-green-500 w-full p-4 py-1" type="password" name="password" id="password" />
